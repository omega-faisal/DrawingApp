...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ib_allclear:ImageButton= findViewById(R.id.ib_allErase)
        ib_allclear.setOnClickListener{
            drawingView?.onClickAllClear()
        }
        ...
        ibSave.setOnClickListener{
            ...
            if (isReadStorageAllowed()){
                ...
                lifecycleScope.launch{
                    ...
                    val getBitmap:Bitmap=getBitmapFromView(flDrawingView)
                    saveBitmapFile(getBitmap)
                }
            }
            else{
                showRationaleDialog("Kids Drawing App","Kids Drawing App " +
                        "needs to Access Your External Storage"+"\nplease change the permission settings")
            }
        }
...
//         */
    ...
    private suspend fun shareBitmapFile(mBitmap: Bitmap?):String{
        var result = ""
        // we are creating this shareBitmap function which will eventually save the file to a location and
        //will open the sharing intent if the saved image is not empty
        // this function is different from save bitmap file because that function does only save the file.
        withContext(Dispatchers.IO) {
            if (mBitmap != null) {
    ...
    private fun ShowProgressDialog()
    {
        ...
        CustomProgressDialog!!.setContentView(R.layout.progrssdialog_custom)
    ...
    private fun shareImage(shareresult:String)
    {
        ShowCancelProgressDialog()
        // this will dismiss the progress dialog and then will show the intent.
        MediaScannerConnection.scanFile(this, arrayOf(shareresult),null)
        {
            path,uri->
